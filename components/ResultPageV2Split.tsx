    ...
    <div className="min-h-screen bg-[#0d1117]">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {onBack && (
          <button
            onClick={onBack}
            className="flex items-center text-white/50 hover:text-white/80 transition-colors text-sm mb-6"
          >
        ...
        >
          ...
          {default_view.confidence && (
            <p className="text-xs text-white/30 -mt-4 ml-1">
          ...
          {default_view.confidence && default_view.confidence.ownership_confidence_pct < 85 && (
            <p className="text-xs text-white/30 ml-1 -mt-4">
        ...
        {/* ========== DIVIDER ========== */}
        <div className="my-10 border-t border-white/[0.08] relative">
          <span className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#0d1117] px-4 text-xs text-white/30 uppercase tracking-wider">
            Detailed Analysis
          </span>
        </div>
        ...
        {isPollingPayment && (
          <div className="text-center py-3 px-4 bg-[#00d97e]/10 border border-[#00d97e]/20 rounded-xl text-sm text-[#00d97e] animate-pulse">
            Confirming your payment...
          </div>
        )}

        {/* Footer */}
        <div className="mt-12 pt-6 border-t border-white/[0.08] text-center space-y-1">
          <p className="text-xs text-white/25">© 2025 OFFO · This report is for informational purposes only</p>
          <div className="flex items-center justify-center gap-4 text-xs text-white/20">
            ...
            <Link href="/deals" className="hover:text-white/40 transition-colors">Deal Watch</Link>
            <a href="/routine" className="hover:text-white/40 transition-colors">EV Fit Check</a>
          </div>
        </div>
      </div>
    </div>
