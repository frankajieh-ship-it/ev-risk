    ...
    <div className={`min-h-screen bg-gradient-to-br ${bgClass}`}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            {paymentsEnabled && !isUnlocked ? (
              <>
                ...
                >
                  ...
                  {checkoutLoading ? "Loading..." : "Get Full Report"}
                </button>
                <p className="text-xs text-gray-500 mt-2">Free — includes PDF + listing receipt</p>
              </>
            ) : (
              <>
                <button
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 text-center space-y-1">
          <p className="text-xs text-gray-400">© 2025 OFFO · This report is for informational purposes only</p>
          <div className="flex items-center justify-center gap-4 text-xs text-gray-300">
            <a href="/about" className="hover:text-gray-500 transition-colors">About</a>
            <Link href="/deals" className="hover:text-gray-500 transition-colors">Deal Watch</Link>
            <a href="/routine" className="hover:text-gray-500 transition-colors">EV Fit Check</a>
          </div>
        </div>
      </div>
    </div>
