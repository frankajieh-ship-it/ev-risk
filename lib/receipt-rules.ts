 ...
 *
 * V2 fields (risk_v2, confidence_v2, evidence_type) power the new
 * scoring matrix with CEO-defined thresholds.
 */
...
export type EvidenceType = "present" | "absent" | "negative" | "friction";
...
export interface ReceiptRule {
  ...
  points: number;
  label: string;
  /** V2: contribution to risk_points total (0-10 scale) */
  risk_v2: number;
  /** V2: contribution to confidence_points total (0-8 scale) */
  confidence_v2: number;
  /** V2: evidence classification for UI copy */
...
export const HARD_BLOCKERS: ReceiptRule[] = [
  { id: "title_salvage", type: "hard_blocker", category: "listing_risk", points: 0, label: "Salvage, rebuilt, flood, or lemon title detected", risk_v2: 0, confidence_v2: 0, evidence_type: "negative" },
  { id: "frame_damage_major", type: "hard_blocker", category: "listing_risk", points: 0, label: "Major structural or frame damage reported", risk_v2: 0, confidence_v2: 0, evidence_type: "negative" },
...
export const FIT_PENALTIES: ReceiptRule[] = [
  ...
  { id: "prior_damage_minor", type: "fit_penalty", category: "listing_risk", points: -10, label: "Minor prior damage disclosed but not reflected in price", risk_v2: 2, confidence_v2: 0, evidence_type: "negative" },
  { id: "ownership_turnover_high", type: "fit_penalty", category: "listing_risk", points: -8, label: "3+ owners in short vehicle life or suspicious turnover", risk_v2: 1, confidence_v2: 0, evidence_type: "negative" },
...
export const EVIDENCE_BONUSES: ReceiptRule[] = [
  { id: "clean_title_explicit", type: "evidence_bonus", category: "listing_risk", points: 10, label: "Clean title explicitly stated", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
  { id: "battery_report_recent", type: "evidence_bonus", category: "missing_proof", points: 20, label: "Recent battery health report provided", risk_v2: 0, confidence_v2: 2, evidence_type: "present" },
  { id: "battery_warranty_info", type: "evidence_bonus", category: "missing_proof", points: 8, label: "Battery warranty status clearly shown", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
  { id: "service_records_shown", type: "evidence_bonus", category: "missing_proof", points: 10, label: "Service or maintenance records shown", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
  { id: "dcfc_confirmed", type: "evidence_bonus", category: "missing_proof", points: 10, label: "DC fast charging support confirmed", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
  { id: "charging_port_photo", type: "evidence_bonus", category: "missing_proof", points: 5, label: "Charging port photo or connector shown", risk_v2: 0, confidence_v2: 0, evidence_type: "present" },
  { id: "vin_decoded", type: "evidence_bonus", category: "missing_proof", points: 10, label: "VIN decoded and matches listing", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
  { id: "ownership_history_clear", type: "evidence_bonus", category: "listing_risk", points: 5, label: "Ownership history shown", risk_v2: 0, confidence_v2: 1, evidence_type: "present" },
