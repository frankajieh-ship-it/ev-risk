...
import { Search, SlidersHorizontal, Loader2, Car, MapPin, Shield, X, Zap } from "lucide-react";
...
function VehicleCard({ v }: { v: VehicleListing }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-md hover:border-gray-300 transition-all group">
      ...
      <div className="px-4 pb-4">
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold rounded-lg transition-colors"
        >
