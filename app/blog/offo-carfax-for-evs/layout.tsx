...
const post = getPostBySlug("offo-carfax-for-evs")!;
const ogTitle = post.title;
const ogSubtitle = "Battery health, charging fit, EV-specific recalls — the vehicle history report Carfax structurally cannot build.";
