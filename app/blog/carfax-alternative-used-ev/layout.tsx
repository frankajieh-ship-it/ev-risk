...
const post = getPostBySlug("carfax-alternative-used-ev")!;
const ogTitle = post.title;
const ogSubtitle = "After testing every major VIN report service on real EV listings, one tool completely changed how I evaluate deals.";
