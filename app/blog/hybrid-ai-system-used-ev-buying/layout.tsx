...
const post = getPostBySlug("hybrid-ai-system-used-ev-buying")!;
const ogTitle = post.title;
const ogSubtitle = "Deterministic-first scoring + hedged multi-LLM chain for used EV and Copart analysis.";
