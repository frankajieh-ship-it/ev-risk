...
export default function DealerLayout({ children }: { children: React.ReactNode }) {
  ...
  // Subscription gate — null or "canceled" blocks access
    ...
    return (
      <div className="min-h-screen bg-[#0d1117] flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white/[0.05] rounded-2xl border border-white/10 p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-white mb-2">Activate your dealer account</h1>
          <p className="text-sm text-white/50 mb-6 leading-relaxed">
            Your subscription has {subscriptionStatus === "canceled" ? "been cancelled" : "expired"}. Subscribe to regain access to your dealer workspace, inventory, and buyer leads.
          </p>
          <button
            onClick={handleSubscribe}
            disabled={checkoutLoading}
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00d97e] text-[#0d1117] text-sm font-semibold rounded-lg hover:bg-[#00f090] disabled:opacity-50 transition-colors mb-3"
          >
